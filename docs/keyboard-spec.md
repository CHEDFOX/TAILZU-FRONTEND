  ...
  "props": {
    "mark": {
      ...
      "shapes": [
        ...
        { "id": "link", "kind": "bars", "x1": 444, "y1": 394, "x2": 554, "y2": 486, "thick": 6, "heights": [28, 36, 41, 46, 43, 34, 28], "swell": { "thick": 1.5, "height": 1.07 }, "color": "#E8A23C" },
...
- `shapes`: `rect` (x, y, w, h, rx), `line` (x1, y1, x2, y2, width, cap, dash), `circle` (cx, cy, r), `bars` (x1, y1, x2, y2, thick, heights, swell) — a row of bars across the line from (x1, y1) to (x2, y2), evenly spaced, one per entry of `heights` (each bar's length, centred on the line), `thick` wide; `swell` is what a bar becomes under the signal's bright cluster: `thick` times thicker, `height` times taller. Coordinates are the artboard's; `viewBox` is the part shown, aspect-fit into the key.
